package lessons.lesson30.task1;
...
public abstract class Bank {
    ...
    public Bank(long id, String bankCountry, Currency currency, int numberOfEmployees, double avrSalaryEmployee, long rating, long totalCapital) {
        this.id = id;
